...
app.post("/emailSender",async (req,res) => {
  ...
  let transporter = nodemailer.createTransport({
    ...
    secure: false, 
    auth: {
      user:"dusty.lindgren16@ethereal.email", // generated ethereal user
      pass:"QJF7xDqaWjvpwsmQ4p", // generated ethereal password
    },
  });

  // send mail with defined transport object
  let info = await transporter.sendMail({
    from: '"darren 👻" godfrey49@ethereal.email', // sender address
